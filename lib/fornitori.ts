...
export const products: FornitoreProduct[] = [
  {
    ...
    image: "/fornitori/manuale-vinted.jpg",
  ...
  },
  {
    ...
    image: "/fornitori/starter-pack.jpg",
    description: "DA COMPLETARE",
    includes: [],
  },
  {
    ...
    image: "/fornitori/bundle-italiani.jpg",
    description: "DA COMPLETARE",
    includes: [],
  },
  {
    ...
    image: "/fornitori/bundle-internazionali.jpg",
    description: "DA COMPLETARE",
    includes: [],
  },
  {
    ...
    image: "/fornitori/pack-completo.jpg",
    description: "DA COMPLETARE",
    includes: [],
    featured: true,
  },
  {
    ...
    image: "/fornitori/pack-completo-guida-vinted.jpg",
    description: "DA COMPLETARE",
    includes: [],
  },
];
